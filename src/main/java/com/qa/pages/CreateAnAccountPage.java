...
public class CreateAnAccountPage {
	...
	public String GetMandatoryErrorEmail() {
		return MandatoryEmailMessage.getText();
	}
	
	
	public String GetMandatoryErrorPassword() {
		return MandatoryPasswordMessage.getText();
	}
	
	
	public String GetMandatoryErrorFirstName() {
		return MandatoryFirstNameMessage.getText();
	}
	
	
	public String GetMandatoryErrorLastName() {
		return MandatoryLastNameMessage.getText();
	}
	
	public String GetMandatoryErrorConfirmPassword() {
		return MandatoryConfirmPassMessage.getText();
	}
