...
public class TS005_TC003 extends ReportUtil {
	...
	@Test(description = "Verify that search icon with search textbox gets enabled as soon as user enters any string/char in search textbox",groups = {"Functional","Regression"}, dataProvider = "excelData", dataProviderClass = DataGenerator.class)
	public void TS005_TC003(String Search_Val) throws Exception {
		...
		logger1.info("Launched Home page.");
		test.pass("Launched Home page.");
		...
		System.out.println("Search icon button state before entring data :" + homepage.GetStateSearchIconSearchTextbox());
		
		// Checking default state of Search Icon inside Search text-box.
		System.out.println("Default state of search textboix :"+homepage.GetStateSearchIconSearchTextbox());
		...
		// Checking default state of Search Icon inside Search text-box.
		System.out.println("SearchIcon button state after entring data :" + homepage.GetStateSearchIconSearchTextbox());
		if (homepage.GetStateSearchIconSearchTextbox()) {
			sa.assertTrue(true);
